...
<header id="rs-header" class="rs-header">
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="main-menu">
                            ...
                            <nav class="rs-menu">
                                <ul class="nav-menu">
                                    <!-- Home -->
                                    <li class="current-menu-item current_page_item menu-item-has-children"> <a href="#" class="home"></a>
                                </ul>
                                </li>
                                <!-- End Home --> 
                                {{--
    ...
    <!-- Menu End -->
    {{--<marquee  direction = "right" width="100%" style="color:#FFFFFF;">email us at jaajaitsolutions@gmail.com | call us on 0777745520 0r 0776913451 for more information | Opposite Christ The King Church ,Portal Avenue, King Ceasor Plaza, Plot no. 9, Uganda Kampala, jaaja IT Solutions limited</marquee>--}}
</header>
<!--Header End-->