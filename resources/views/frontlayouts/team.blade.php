<!-- Team Start -->
        <div id="rs-team-2" class="rs-team-2 team-page sec-spacer pt-0 pb-0">
			<div class="container">
                <div class="gridFilter">
                    <button class="active" data-filter="*">Our Products</button>
                    <button data-filter=".filter1">Check out Our Products</button>
                </div>
				<div class="row grid">
