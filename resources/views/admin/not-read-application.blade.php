                                    ...
                                    <div class="card-body">
                                        <div class="dt-responsive table-responsive">
                                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                ...
                                                <tbody>
                                                    @foreach($not_read_applications as $unread)
                                                    <tr>
                                                        <td>{{$unread->first_name}} {{$unread->last_name}}</td>
                                                        <td>{{$unread->email}}</td>
                                                        <td>{{$unread->language}}</td>
                                                        <td>{{$unread->others}}</td>
                                                        <td>{{$unread->git_link}}</td>
                                                        <td>
                                                        <a href="/change-not-read-to-read/{{$unread->id}}" button class="btn btn-primary">Mark as Read</button></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
