                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>
                                        <a href="/get-form-to-add-news" button class="btn btn-primary mr-0">Add news</button></a>
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$news->image}}</td>
                                                        <td>
                                                        <a href="/edit-news/{{$news->id}}" button class="btn btn-success">Edit</button></a>
                                                        <a href="/delete-news/{{$news->id}}" button class="btn btn-danger">Delete</button></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
